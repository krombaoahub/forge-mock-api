            ...
            <div className='mx-auto flex flex-col'>
                ...
                <div className='flex lg:flex-nowrap flex-wrap gap-6'>
                    <div className='flex flex-col gap-6 p-5 grow text-left w-full'>
                        ...
                        <div className='my-3'>
                             <Link onClick={() => setTimeout(() => { handleGotoSection('loginRef') }, 100)} to={'/login'}  className='btn hover:bg-white/75 bg-white shadow-2xs btn-xl text-primary border-0'><Play size={16} />Start Building Free</Link>
                        </div>
